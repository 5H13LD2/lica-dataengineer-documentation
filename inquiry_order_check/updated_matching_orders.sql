...
WHERE REGEXP_CONTAINS(LOWER(COALESCE(customer_name,'')), r'maybel|ernest|cadiz|camiell|lopez|alyssa|guevarra|regina|hernandez|timz|berm|baricua|gelang|pernad|howard|keith|alcantara|salvador|sandique|abucay|buarao|esquivel|angeles|catacutan|manimtim')
